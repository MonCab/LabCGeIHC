...
std::string fileNames[6] = { 
	"../../Textures/mp_met/met_ft.tga",
	"../../Textures/mp_met/met_bk.tga",
	"../../Textures/mp_met/met_up.tga",
	"../../Textures/mp_met/met_dn.tga",
	"../../Textures/mp_met/met_rt.tga",
	"../../Textures/mp_met/met_lf.tga"
};
...
void applicationLoop() {
	...
	while (psi) {
		...
		//glUniform3fv(shaderSpotLight.getUniformLocation("light.position"), 1, glm::value_ptr(glm::vec3(2.0, 0.0, 5.0)));//5.0
		...
		sphere2.render();
		cylinder2.setPosition(glm::vec3(0.0, 0.0, -12.0));
		cylinder2.render();
