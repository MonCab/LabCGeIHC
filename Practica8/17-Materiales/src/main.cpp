...
void applicationLoop() {
	...
	while (psi) {
		...
		glUniform3f(iluminacionShader.getUniformLocation("light.diffuse"), 1.0, 1.0, 1.0); // 0.4, 0.4, 0.4
		glUniform3f(iluminacionShader.getUniformLocation("light.specular"), 1.0, 1.0, 1.0); //0.5, 0.3, 0.2

		glUniform3f(iluminacionShader.getUniformLocation("material.ambient"), 0.1745, 0.01175, 0.01175); //1.0 0.2, 0.6
		glUniform3f(iluminacionShader.getUniformLocation("material.diffuse"), 0.61424, 0.04136, 0.04136); // 0.4, 0.5, 0.8
		glUniform3f(iluminacionShader.getUniformLocation("material.specular"), 0.727811, 0.626959, 0.626959); //0.5, 0.3, 0.2
		glUniform1f(iluminacionShader.getUniformLocation("material.shininess"), 0.6 * 128.0); //64.0
